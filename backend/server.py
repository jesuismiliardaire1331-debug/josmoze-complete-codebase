from fastapi import FastAPI, APIRouter, HTTPException, Request, Depends, status, UploadFile, File, Form
    ...
    try:
        ...
        if os.path.exists(crm_html_path):
            ...
            <body>
                ...
                <script>
                    const API_BASE = 'https://water-ecom-admin.preview.emergentagent.com/api';
                    let authToken = '';
