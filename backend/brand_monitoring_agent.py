...
MONITORING_CONFIG = {
    ...
    "frontend_url": os.environ.get("REACT_APP_BACKEND_URL", "https://0d683f65-404e-4436-abda-79303fb40932.preview.emergentagent.com").replace("/api", ""),
    "crm_url": os.environ.get("REACT_APP_BACKEND_URL", "https://0d683f65-404e-4436-abda-79303fb40932.preview.emergentagent.com").replace("/api", "") + "/crm",
