...
MONITORING_CONFIG = {
    ...
    "frontend_url": os.environ.get("REACT_APP_BACKEND_URL", "https://www.josmose.com").replace("/api", ""),
    "crm_url": os.environ.get("REACT_APP_BACKEND_URL", "https://www.josmose.com").replace("/api", "") + "/crm",
