        ...
        <div className="mb-8">
          <div className="flex flex-wrap gap-2 bg-white p-2 rounded-xl shadow-lg">
            {[
              ...
              { id: 'email-sequencer', name: 'Email Sequencer', icon: '📧', color: 'from-indigo-600 to-purple-700' },
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {leads.map((lead) => (
                      <tr key={`lead-${lead.id || lead.email}`} className={`hover:bg-blue-50 transition-colors`}>
